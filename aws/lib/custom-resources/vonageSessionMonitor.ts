...
export interface VonageSessionMonitorResourceProps {
...
export class VonageSessionMonitorResource extends Construct {
    constructor(scope: Construct, id: string, props: VonageSessionMonitorResourceProps) {
        super(scope, id);

        const onEventHandler = new NodejsFunction(this, "VonageSessionMonitorLambdaFunction-onEvent", {
            handler: "onEvent",
            entry: path.join(__dirname, "./lambdas/vonageSessionMonitor.ts"),
        ...
        const provider = new customResources.Provider(this, "VonageSessionMonitorProvider", {
            onEventHandler,
            logRetention: RetentionDays.ONE_DAY,
        });
        ...
        new CustomResource(this, "VonageSessionMonitorResource", {
