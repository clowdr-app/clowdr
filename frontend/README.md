...
Refer to the comments in the `vite.config.ts` file regarding server configuration. For local development, you will likely need to comment out the first set of the server hmr configuration options and uncomment the second set of server hmr configuration options.
