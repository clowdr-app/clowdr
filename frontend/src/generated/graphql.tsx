...
export type Chat_Avg_Fields = {
    ...
    lastMessageIndex?: Maybe<Scalars["Float"]>;
};

/** order by avg() on columns of table "Chat" */
export type Chat_Avg_Order_By = {
    lastMessageIndex?: Maybe<Order_By>;
};
...
export type Chat_Bool_Exp = {
    ...
    lastMessageIndex?: Maybe<Int_Comparison_Exp>;
...
export type Chat_Inc_Input = {
    lastMessageIndex?: Maybe<Scalars["Int"]>;
};
...
export type LiveChatSubscription = { __typename?: "subscription_root" } & {
    Chat: Array<
        { __typename?: "Chat" } & Pick<Chat, "id" | "lastMessageIndex"> & {
                typers: Array<
