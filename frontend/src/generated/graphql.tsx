 ...
 * });
 */
export function useEchoQueryQuery(baseOptions: Apollo.QueryHookOptions<EchoQueryQuery, EchoQueryQueryVariables>) {
        return Apollo.useQuery<EchoQueryQuery, EchoQueryQueryVariables>(EchoQueryDocument, baseOptions);
      }
export function useEchoQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EchoQueryQuery, EchoQueryQueryVariables>) {
          return Apollo.useLazyQuery<EchoQueryQuery, EchoQueryQueryVariables>(EchoQueryDocument, baseOptions);
        }
export type EchoQueryQueryHookResult = ReturnType<typeof useEchoQueryQuery>;
export type EchoQueryLazyQueryHookResult = ReturnType<typeof useEchoQueryLazyQuery>;
export type EchoQueryQueryResult = Apollo.QueryResult<EchoQueryQuery, EchoQueryQueryVariables>;