...
BEGIN
    SELECT COUNT(*) INTO existingCount FROM presence."OpenTab" WHERE "path" = NEW."path" AND "attendeeId" = NEW."attendeeId" LIMIT 1;
...
DECLARE
    ...
    existingCount integer;
BEGIN
    SELECT COUNT(*) INTO existingCount FROM presence."OpenTab" WHERE "path" = OLD."path" AND "attendeeId" = OLD."attendeeId" LIMIT 1;
