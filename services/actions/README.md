...
## Full Setup: Deploying the image handler
...
| AWS_IMAGES_CLOUDFRONT_DISTRIBUTION_NAME          | The name of the CloudFront (separate AWS service from CloudFormation!) distribution obtained from deploying the Serverless Image Handler template (e.g. `f9da4dbs83dnsl`) | AWS CloudFront           |
| AWS_IMAGES_SECRET_VALUE                          | The value you manually entered into Secrets Manager.                                                                                                                      | Generated Earlier        |
