...
export const fallbackTemplates = {
    ...
    //   </head>
    //   <body>
    //     <!--<span class="preheader">{{excerpt}}</span>-->
    //     <table
    //       class="email-wrapper"
    //       width="100%"
    //       cellpadding="0"
    ...
    //                                     please contact your conference organisers via
    //                                     their website or at
    ...
    //                                 </p>
    //                               {{/if}}
    //                               {{#if techSupportAddress}}
    //                                 <p class="f-fallback sub">
    //                                     If you require technical support, such as an
    //                                     error message within Midspace, please contact
    //                                     <a href="mailto:{{techSupportAddress}}"
    //                                     >{{techSupportAddress}}</a
    //                                     >.
    //                                 </p>
    //                               {{/if}}
    //                             </td>
