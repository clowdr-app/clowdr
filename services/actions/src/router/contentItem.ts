...
async function validateSNSNotification(body: any): Promise<Maybe<SNSNotification<any>>> {
...
router.post("/notifyTranscode", bodyParser.text(), async (req: Request, res: Response) => {
...
router.post("/notifyTranscribe", bodyParser.text(), async (req: Request, res: Response) => {
    console.log(req.originalUrl);
